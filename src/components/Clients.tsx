...
import kirby from "../assets/clients/kirby.svg"
...
const images = [
  volkeswagen, hero, indianoil, sos, icg, itzcash, delmonte, wu, maruti, escorts, kirby, american, 
  sembcorp, task, convergys, concentrix, tadiran, samsung, nynas, aai, moc, stellar, nokia, shoolini, jnu,
  jwmarriot, srm, imi, gartner, bata, tcs, colt, mars, iris, nestle, baidu, careindia, bankofamerica,
  barclays, durrdentals, encore, godfrey, google, hsbc, infinite, genpact, gmr, luminous, mdh, oracle,
  procam, weace, sahara, timesgroup, vestergaard
];
