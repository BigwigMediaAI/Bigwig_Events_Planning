...
<div>
  ...
  Bringing your dream <strong>weddings</strong> and <strong>events</strong> to life with unmatched elegance. 
  Based in <span className="underline">Boston</span> and <span className="underline">New York City</span>, we serve 
